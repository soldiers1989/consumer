...
@ActivityScope
class ClassicCasePresenter
@Inject
constructor(model: ClassicCaseContract.Model, rootView: ClassicCaseContract.View) :
    BasePresenter<ClassicCaseContract.Model, ClassicCaseContract.View>(model, rootView) {
    @Inject
