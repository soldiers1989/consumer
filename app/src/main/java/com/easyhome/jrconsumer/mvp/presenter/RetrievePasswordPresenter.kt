...
@ActivityScope
class RetrievePasswordPresenter
@Inject
constructor(model: RetrievePasswordContract.Model, rootView: RetrievePasswordContract.View) :
    BasePresenter<RetrievePasswordContract.Model, RetrievePasswordContract.View>(model, rootView) {
    @Inject
