...
import com.easyhome.jrconsumer.di.component.DaggerUserDataComponent
import com.easyhome.jrconsumer.di.module.UserDataModule
import com.easyhome.jrconsumer.mvp.contract.user.UserDataContract
import com.easyhome.jrconsumer.mvp.presenter.user.UserDataPresenter
...
class UserDataActivity : JRBaseActivity<UserDataPresenter>(), UserDataContract.View {
    ...
    override fun initData(savedInstanceState: Bundle?) {
        ...
        moreIV2.singleClick {
          startActivity<AlterPasswordActivity>()
        }
        moreIV4.singleClick {
          startActivity<AlterGenderActivity>()
        }
