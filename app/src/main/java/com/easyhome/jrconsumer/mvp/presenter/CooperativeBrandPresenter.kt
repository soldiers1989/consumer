...
@ActivityScope
class CooperativeBrandPresenter
@Inject
constructor(model: CooperativeBrandContract.Model, rootView: CooperativeBrandContract.View) :
    BasePresenter<CooperativeBrandContract.Model, CooperativeBrandContract.View>(model, rootView) {
    @Inject
